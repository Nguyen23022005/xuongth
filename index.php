...
$router->addRoute("/profile/{id}", [$profileController, "profile"], ['isUser']);
$router->addRoute("/profile/edit/{id}", [$profileController, "edit"], );
...
$router->addRoute("/checkout/process", [$cartController, "processCheckout"]);
$router->addRoute("/order-success", [$cartController, "orderSuccess"]);

$router->addRoute("/checkout", [$cartController, "checkout"]);
$router->addRoute("/checkout/process", [$cartController, "processCheckout"]);
$router->addRoute("/order-success", [$cartController, "orderSuccess"]);

$router->addRoute("/orders", [$cartController, "orderList"]);
$router->addRoute("/ordersadmin", [$cartController, "orderListadmin"]);
$router->addRoute("/orders/update/{order_id}", [$cartController, "updateStatus"]);
$router->addRoute("/orders/review/{order_id}", [$cartController, "review"]);
// 
...
$router->addRoute("/questions/delete/{id}", [$testController, "questions_delete"]);
