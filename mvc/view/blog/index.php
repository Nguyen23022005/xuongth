...
.table .content-column {
    ...
    max-width: 250px; /* Giới hạn chiều rộng cột nội dung */
}
.btn-sm {
    padding: 0.25rem 0.5rem; /* Nút nhỏ gọn hơn */
    font-size: 0.875rem;
}
.btn-group .btn {
...
.card-header {
    border-radius: 10px 10px 0 0; /* Bo góc trên của card-header */
}
.alert {
    border-radius: 8px; /* Bo góc cho alert */
}
</style>
